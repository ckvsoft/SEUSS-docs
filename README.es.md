[checo](README.cs.md)-[danés](README.da.md)-[Alemán](README.de.md)-[Inglés](README.md)-[Español](README.es.md)-[estonio](README.et.md)-[Finnish ](README.fi.md)-[Francés](README.fr.md)-[Griego](README.el.md)-[italiano](README.it.md)-[Holandés](README.nl.md)-[Norsk ](README.no.md)-[Polaco](README.pl.md)-[portugués](README.pt.md)-[sueco](README.sv.md)-[japonés](README.ja.md)
...
| Configuración                              | Significado                                                                                                                                                                                                                                                                     |
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `use_second_day`                           | habilitar/deshabilitar la comparación de precios de hoy y mañana si están disponibles<br/>Note: If you activate this and the prices decrease over several days,it is possible that there will be no charging or switching for several days until the lowest prices are reached. |
...
| `ip_address`  | La dirección IP local de Victron.<br/>Esto es necesario si "use_vrm" está deshabilitado (falso).<br/>Otherwise this field remains empty                                                                         |
...
| Configuración | Significado                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| :------------ | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `api_token`   | Cómo obtener el token de seguridad API gratuito:<br/>1. Ir a<https://transparency.entsoe.eu/> --> register and create an account<br/>2. Envíe un correo electrónico a[transparency@entsoe.eu](mailto:transparency@entsoe.eu)con "Acceso API Restful" en la línea de asunto<br/>3. El servicio de asistencia técnica de ENTSO-E responderá a su solicitud en un plazo de 3 días laborables.<br/>4. Genere un token de seguridad en<https://transparency.entsoe.eu/usrm/user/myAccountSettings> |
