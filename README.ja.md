...
| 設定              | 意味                                                                                      |
| --------------- | --------------------------------------------------------------------------------------- |
| `time_zone`     | 地理的位置に基づいて操作を適切なタイミングで行うために不可欠です。<br/>のようなフォーマット`Europe/Vienna`、`Europe/Amsterdam`、 。。。 |
...
| 設定                                         | 意味                                                                                                                                                                                                                           |
| ------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `use_second_day`                           | 今日と明日の価格が利用可能になった場合の比較を有効または無効にします<br/>Note: If you activate this and the prices decrease over several days,it is possible that there will be no charging or switching for several days until the lowest prices are reached. |
