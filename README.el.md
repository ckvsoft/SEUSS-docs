...
| Σύνθεση         | Εννοια                                                                                                                           |
| --------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `time_zone`     | Απαραίτητο για τον σωστό χρόνο των εργασιών με βάση τη γεωγραφική σας θέση.<br/>Μορφή όπως Ευρώπη/Βιέννη, Ευρώπη/Άμστερνταμ, ... |
...
| Σύνθεση                                    | Εννοια                                                                                                                                                                                                                                                                                      |
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `use_second_day`                           | ενεργοποιήστε/απενεργοποιήστε τη σύγκριση των σημερινών και των αυριανών τιμών εάν γίνουν διαθέσιμες<br/>Σημείωση: Εάν το ενεργοποιήσετε και οι τιμές μειωθούν σε αρκετές ημέρες, είναι πιθανό να μην υπάρξει χρέωση ή αλλαγή για αρκετές ημέρες έως ότου επιτευχθούν οι χαμηλότερες τιμές. |
...
Το επίπεδο καταγραφής ERROR υποδεικνύει συνθήκες σφάλματος σε μια εφαρμογή που εμποδίζουν την εκτέλεση μιας συγκεκριμένης λειτουργίας. Ενώ η εφαρμογή μπορεί να συνεχίσει να λειτουργεί σε μειωμένο επίπεδο λειτουργικότητας ή απόδοσης,<br/>Τα αρχεία καταγραφής ΣΦΑΛΜΑΤΩΝ υποδηλώνουν ζητήματα που πρέπει να διερευνηθούν εγκαίρως.

### ΠΡΟΕΙΔΟΠΟΙΩ

Τα συμβάντα που καταγράφονται σε επίπεδο ΠΡΟΕΙΔΟΠΟΙΗΣΗΣ συνήθως υποδεικνύουν ότι έχει συμβεί κάτι απροσδόκητο
...
Το επίπεδο INFO καταγράφει συμβάντα στο σύστημα που είναι σημαντικά για το
...
Το επίπεδο DEBUG χρησιμοποιείται για την καταγραφή μηνυμάτων που βοηθούν τους προγραμματιστές να αναγνωρίσουν
