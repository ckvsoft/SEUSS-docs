...
-   Hier werden Tooltipps für die meisten Punkte angezeigt.
...
Für diejenigen, die lieber in einer Konfigurationsdatei arbeiten, gibt es config.json
...
| `total_area`      | Gesamtfläche der Paneele in Quadratmetern                                                    |
| `damping_morning` | Mit diesem Parameter können Sie das Ergebnis am Morgen anpassen. Wert float 0..1, Standard 0 |
| `damping_evening` | Mit diesem Parameter können Sie das Ergebnis abends anpassen. Wert float 0..1, Standard 0    |
| `enabled`         | Um diesen Eintrag nutzen zu können, muss er vorhanden sein`enabled`. Ansonsten`disabled`     |
